<div class="hordeauthor">
  <h2>Mike Hardy</h2>
  <ul>
    <li><a href="http://www.glacier.rice.edu/~mhardy">Fairly Static Personal
    ...
    <li><a href="http://www.mikehardy.net">vanity domain</a> so I have a stable net
    presence...</li>
    <li>Here's a <a href="http://www.h3c.com/mike_load.php">resume</a> if
    you're curious where I come from professionally.</li>
   ...
   fascinated by various aspects of human sociology.</li>
</ul>
