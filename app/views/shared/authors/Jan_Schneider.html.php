<div class="hordeauthor">
  ...
  <ul>
    ...
    <li>Co-founder of <a href="http://web.horde.to/ammma.de/">AMMMa AG</a>, providing
     innovative, award winning e-learning and knowledge management
     solutions.</li>
    <li>Studied Computer Science and Educational Science
      at <a href="http://web.horde.to/uni-bielefeld.de/">University of Bielefeld</a>,
      Germany.</li>
    <li>Website: <a href="http://web.horde.to/janschneider.de/">http://janschneider.de</a></li>
    <li>Amazon wishlist: <a href="http://web.horde.to/amazon.de/exec/obidos/registry/3DQXLRXA5BENK">amazon.de</a>.</li>
 </ul>
</div>
