<div class="content">
  <div class="main">
    <div class="mainareasplit">
        ...
        <div class="section">
         <p class="exciter">The Horde Project provides two levels of support
         for our software - community based support and paid, professional
         support.</p>

         <p class="exciter">Note that we can only address problems related to the Horde
         ...
         <h3><?php echo $this->linkTo('Community', array('controller' => 'community', 'action' => 'support'))?></h3>
         ...
         <h3><?php echo $this->linkTo('Professional Services', array('controller' => 'services', 'action' => 'index'))?></h3>
         ...
         <p>Please see our
         <?php echo $this->linkTo('Professional Services', array('controller' => 'services', 'action' => 'index'))?>
