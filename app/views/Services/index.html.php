<div class="content">
  <div class="main">
    <div class="mainareasplit">
        ...
        <p class="exciter">Our team of trusted professionals helps you build large installations or custom applications.</p>
        ...
        <ul>
            ...
            <li>Feature-rich. Horde's feature set rivals the largest enterprise email systems.  We have an incredible feature set that compares favorably against any competition in our primary apps (mail, calendar address book), and even more in our secondary apps (time tracking, wiki, ticketing, and more).</li>
            <li>Open Source. Horde is open source, which means there are never per-user licensing fees or costly mandatory support contracts.  It also means that, if necessary, you can customize any part of Horde at any time.</li>
        ...
        <p>We love to talk shop.  Give us a call at <span style="font-weight: bold;">+1.404.475.4830</span> or drop us a line at <a href="mailto:info@horde.org" style="font-weight: bold;">info@horde.org</a>.  We will set up a time to discuss your project and help you establish a roadmap for achieving your objectives.</p>
        </div>
    </div>
