    ...
    <div class="mainareasplit">
        ...
        <div class="section">
          <div class="sectionintro">
            <p>This is a list of the major released <strong>Horde 6</strong>
            ...
            <p>Can't find your favorite application listed for Horde 6?
            Not all of our applications have been ported to Horde 6 yet.
            Please check our <a href="<?php echo
            $this->urlWriter->urlFor('apps_h5') ?>">Horde 5
            Apps</a> page.</p>
          ...
          <p>Horde and all Horde applications are installed via Composer.
          You can install all Horde applications and libraries by following
          the directions in the <a href="<?php echo
          $this->urlWriter->urlFor(array('controller' => 'app', 'app' =>
          'horde', 'action' => 'docs', 'file' => 'INSTALL'))
          ?>">documentation</a>. All packages are available from
          ...
          developed for a Horde 6 release. Can't wait? Chora is available for
          older Horde versions, or you can use the bleeding edge development
          code.</p>
          ...
          <h3><a href="<?php echo $this->urlWriter->urlFor('app', array('app'
          => 'hermes')) ?>">Hermes</a> <?php echo
          HordeWeb_Utils::downloadIcon($this, 'hermes') ?></h3>
          <p>Hermes is a Horde time-tracking application. It ties into address
          books (to retrieve clients) and task lists, bug trackers etc. (to
          retrieve cost objects). It comes with a stop watch, search and
          reporting capabilities and an invoice interface.</p>
