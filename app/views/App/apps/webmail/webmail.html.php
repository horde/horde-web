...
<ul>
 ...
 <li>Built in attachment viewers</li>
 <li>Encrypting and signing of messages (S/MIME and PGP)</li>
 <li>Quota support</li>
 ...
 <li>Graphical emoticons</li>
 <li>Support for mailing list headers</li>
 <li>Forwarding of multiple messages at once</li>
 <li>Attachments sent as links</li>
</ul>
</div>