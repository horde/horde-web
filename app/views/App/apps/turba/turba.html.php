...
changing the configuration files. You can import/export from/to CSV, TSV, and
vCard contacts. You can create distribution lists from your addressbooks, which
are handled transparently by IMP and other Horde applications. You can share
address books with other users. Turba can work as a CardDAV servers for
external address book clients. And there are Horde API functions to add and
