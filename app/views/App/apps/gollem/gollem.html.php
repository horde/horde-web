...
SQL database, as part of a real filesystem, or on an FTP server. It uses the
<a href="<?php echo $this->urlWriter->urlFor('app', array('app' => 'horde')) ?>">Horde's</a> MIME_Viewer framework to identify file types,
associate icons, etc.</p>
