    ...
    <div class="mainareasplit">
        ...
        <div class="section">
          <div class="sectionintro">
            <p class="alert">This is a list of Horde 3 applications. Most of
            these applications have been deprecated by the newer Horde 4
            versions.</p>
            ...
            <h3><a href="<?php echo $this->urlWriter->urlFor('app', array('app' => 'dimp')) ?>">DIMP</a></h3>
            ...
            <h3><a href="<?php echo $this->urlWriter->urlFor('app', array('app' => 'mimp')) ?>">MIMP</a></h3>
