<?php
/**
 * Modern PSR-15 Services Controller
 *
 * Handles requests to the services page using PSR-7/15 standards.
 *
...
/**
 * Services controller - PSR-15 RequestHandler
 */
class Services implements RequestHandlerInterface
{
    ...
    private function setupView(): \Horde_View_Base
    {
        ...
        // Add template path for Services views
