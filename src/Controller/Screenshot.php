<?php
/**
 * Modern PSR-15 Screenshot Controller
 *
 * Handles requests to the screenshot pages using PSR-7/15 standards.
 *
...
/**
 * Screenshot controller - PSR-15 RequestHandler
 */
class Screenshot implements RequestHandlerInterface
{
    ...
    private function setupView(): \Horde_View_Base
    {
        ...
        // Add template path and properties for Screenshot views
